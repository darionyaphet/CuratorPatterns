...
public class CreateSpec implements org.apache.thrift.TBase<CreateSpec, CreateSpec._Fields>, java.io.Serializable, Cloneable {
...
;
  ...
  public void unsetCreatingParentsIfNeeded() {
    __isset_bit_vector.clear(__CREATINGPARENTSIFNEEDED_ISSET_ID);
  }
  ...
  public boolean isSetCreatingParentsIfNeeded() {
    return __isset_bit_vector.get(__CREATINGPARENTSIFNEEDED_ISSET_ID);
  }

  public void setCreatingParentsIfNeededIsSet(boolean value) {
    __isset_bit_vector.set(__CREATINGPARENTSIFNEEDED_ISSET_ID, value);
  }
  ...
  public void unsetWithProtection() {
    __isset_bit_vector.clear(__WITHPROTECTION_ISSET_ID);
  }
  ...
  public boolean isSetWithProtection() {
    return __isset_bit_vector.get(__WITHPROTECTION_ISSET_ID);
  }

  public void setWithProtectionIsSet(boolean value) {
    __isset_bit_vector.set(__WITHPROTECTION_ISSET_ID, value);
  }
  ...
  public int compareTo(CreateSpec other) {
    ...
    CreateSpec typedOther = (CreateSpec)other;
    ...
    lastComparison = Boolean.valueOf(isSetCreatingParentsIfNeeded()).compareTo(typedOther.isSetCreatingParentsIfNeeded());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCreatingParentsIfNeeded()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.creatingParentsIfNeeded, typedOther.creatingParentsIfNeeded);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetWithProtection()).compareTo(typedOther.isSetWithProtection());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWithProtection()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.withProtection, typedOther.withProtection);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
