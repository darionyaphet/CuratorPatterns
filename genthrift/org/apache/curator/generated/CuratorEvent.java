...
public class CuratorEvent implements org.apache.thrift.TBase<CuratorEvent, CuratorEvent._Fields>, java.io.Serializable, Cloneable {
...
;
    ...
    if (other.isSetAclList()) {
      List<Acl> __this__aclList = new ArrayList<Acl>();
  ...
  public int compareTo(CuratorEvent other) {
    ...
    CuratorEvent typedOther = (CuratorEvent)other;
    ...
    if (isSetStat()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stat, typedOther.stat);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetAclList()).compareTo(typedOther.isSetAclList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAclList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.aclList, typedOther.aclList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetWatchedEvent()).compareTo(typedOther.isSetWatchedEvent());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWatchedEvent()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.watchedEvent, typedOther.watchedEvent);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLeaderEvent()).compareTo(typedOther.isSetLeaderEvent());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLeaderEvent()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.leaderEvent, typedOther.leaderEvent);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetChildrenCacheEvent()).compareTo(typedOther.isSetChildrenCacheEvent());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChildrenCacheEvent()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.childrenCacheEvent, typedOther.childrenCacheEvent);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
