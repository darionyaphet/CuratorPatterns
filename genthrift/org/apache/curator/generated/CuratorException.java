...
public class CuratorException extends Exception implements org.apache.thrift.TBase<CuratorException, CuratorException._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(CuratorException other) {
    ...
    CuratorException typedOther = (CuratorException)other;
    ...
    lastComparison = Boolean.valueOf(isSetZooKeeperException()).compareTo(typedOther.isSetZooKeeperException());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetZooKeeperException()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.zooKeeperException, typedOther.zooKeeperException);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNodeException()).compareTo(typedOther.isSetNodeException());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNodeException()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nodeException, typedOther.nodeException);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
