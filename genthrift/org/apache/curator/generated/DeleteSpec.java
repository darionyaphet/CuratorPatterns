...
public class DeleteSpec implements org.apache.thrift.TBase<DeleteSpec, DeleteSpec._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(DeleteSpec other) {
    ...
    DeleteSpec typedOther = (DeleteSpec)other;
    ...
    lastComparison = Boolean.valueOf(isSetGuaranteed()).compareTo(typedOther.isSetGuaranteed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGuaranteed()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.guaranteed, typedOther.guaranteed);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
