...
public class DiscoveryInstance implements org.apache.thrift.TBase<DiscoveryInstance, DiscoveryInstance._Fields>, java.io.Serializable, Cloneable {
...
;
  ...
  public void unsetRegistrationTimeUTC() {
    __isset_bit_vector.clear(__REGISTRATIONTIMEUTC_ISSET_ID);
  }
  ...
  public boolean isSetRegistrationTimeUTC() {
    return __isset_bit_vector.get(__REGISTRATIONTIMEUTC_ISSET_ID);
  }

  public void setRegistrationTimeUTCIsSet(boolean value) {
    __isset_bit_vector.set(__REGISTRATIONTIMEUTC_ISSET_ID, value);
  }
  ...
  public int compareTo(DiscoveryInstance other) {
    ...
    DiscoveryInstance typedOther = (DiscoveryInstance)other;
    ...
    lastComparison = Boolean.valueOf(isSetSslPort()).compareTo(typedOther.isSetSslPort());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSslPort()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sslPort, typedOther.sslPort);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetRegistrationTimeUTC()).compareTo(typedOther.isSetRegistrationTimeUTC());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRegistrationTimeUTC()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.registrationTimeUTC, typedOther.registrationTimeUTC);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetUriSpec()).compareTo(typedOther.isSetUriSpec());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUriSpec()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.uriSpec, typedOther.uriSpec);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
