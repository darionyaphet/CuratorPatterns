...
public class GetDataSpec implements org.apache.thrift.TBase<GetDataSpec, GetDataSpec._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(GetDataSpec other) {
    ...
    GetDataSpec typedOther = (GetDataSpec)other;
    ...
    lastComparison = Boolean.valueOf(isSetWatched()).compareTo(typedOther.isSetWatched());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWatched()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.watched, typedOther.watched);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetDecompressed()).compareTo(typedOther.isSetDecompressed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDecompressed()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.decompressed, typedOther.decompressed);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
