...
public class Id implements org.apache.thrift.TBase<Id, Id._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(Id other) {
    ...
    lastComparison = Boolean.valueOf(isSetScheme()).compareTo(typedOther.isSetScheme());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetScheme()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.scheme, typedOther.scheme);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
