...
public class OptionalLockProjection implements org.apache.thrift.TBase<OptionalLockProjection, OptionalLockProjection._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(OptionalLockProjection other) {
    ...
    OptionalLockProjection typedOther = (OptionalLockProjection)other;

    lastComparison = Boolean.valueOf(isSetLockProjection()).compareTo(typedOther.isSetLockProjection());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLockProjection()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.lockProjection, typedOther.lockProjection);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
