...
public class Stat implements org.apache.thrift.TBase<Stat, Stat._Fields>, java.io.Serializable, Cloneable {
  ...
  public void unsetEphemeralOwner() {
    __isset_bit_vector.clear(__EPHEMERALOWNER_ISSET_ID);
  }
  ...
  public boolean isSetEphemeralOwner() {
    return __isset_bit_vector.get(__EPHEMERALOWNER_ISSET_ID);
  }

  public void setEphemeralOwnerIsSet(boolean value) {
    __isset_bit_vector.set(__EPHEMERALOWNER_ISSET_ID, value);
  }
  ...
  public int compareTo(Stat other) {
    ...
    lastComparison = Boolean.valueOf(isSetCzxid()).compareTo(typedOther.isSetCzxid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCzxid()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.czxid, typedOther.czxid);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetMzxid()).compareTo(typedOther.isSetMzxid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMzxid()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mzxid, typedOther.mzxid);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetCversion()).compareTo(typedOther.isSetCversion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCversion()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cversion, typedOther.cversion);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAversion()).compareTo(typedOther.isSetAversion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAversion()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.aversion, typedOther.aversion);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetEphemeralOwner()).compareTo(typedOther.isSetEphemeralOwner());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEphemeralOwner()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ephemeralOwner, typedOther.ephemeralOwner);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDataLength()).compareTo(typedOther.isSetDataLength());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDataLength()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataLength, typedOther.dataLength);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNumChildren()).compareTo(typedOther.isSetNumChildren());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumChildren()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numChildren, typedOther.numChildren);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPzxid()).compareTo(typedOther.isSetPzxid());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPzxid()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.pzxid, typedOther.pzxid);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
