...
public class WatchedEvent implements org.apache.thrift.TBase<WatchedEvent, WatchedEvent._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(WatchedEvent other) {
    ...
    WatchedEvent typedOther = (WatchedEvent)other;

    lastComparison = Boolean.valueOf(isSetKeeperState()).compareTo(typedOther.isSetKeeperState());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetKeeperState()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.keeperState, typedOther.keeperState);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
